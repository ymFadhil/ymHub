...
$base_path = '/bm';
$page_title = $lang == 'en' ? 'Simple Booking / Request System | Custom Web Systems in Malaysia | Ym Hub' : 'Sistem Tempahan / Permintaan Mudah | Custom Sistem Web di Malaysia | Ym Hub';
$page_meta_description = $lang == 'en' ? 'Online booking and request system for businesses in Malaysia. Public request form, status management, email notifications. Built with PHP & MySQL.' : 'Sistem tempahan dan permintaan online untuk bisnes di Malaysia. Borang permintaan awam, pengurusan status, notifikasi email. Dibina dengan PHP & MySQL.';
    ...
    <section class="project-detail" style="padding: 150px 0 100px;">
        <div class="container">
            ...
            <div class="project-header" style="text-align: center; margin-bottom: 3rem;">
                ...
                <h1 style="font-size: 2.5rem; font-weight: 700; color: var(--text-dark); margin-bottom: 1rem;">Simple Booking / Request System</h1>
                <p style="font-size: 1.2rem; color: var(--text-gray); max-width: 800px; margin: 0 auto;">A simple request system to organize customer inquiries and service bookings.</p>
            </div>
            ...
            <div class="project-info" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-bottom: 3rem;">
                ...
                <div class="info-card" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); transition: transform 0.2s ease, box-shadow 0.2s ease;">
                    ...
                    <p style="color: var(--text-gray); margin: 0; font-size: 1rem;">RM600 - RM1,200</p>
                </div>
            </div>
