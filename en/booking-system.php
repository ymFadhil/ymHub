...
$base_path = '/en';
$page_title = 'Simple Booking / Request System | Custom Web Systems in Malaysia | Ym Hub';
$page_meta_description = 'Online booking and request system for businesses in Malaysia. Public request form, status management, email notifications. Built with PHP & MySQL.';
    ...
    <section class="project-detail" style="padding: 150px 0 100px;">
        <div class="container">
            ...
            <div class="project-header" style="text-align: center; margin-bottom: 3rem;">
                ...
                <h1 style="font-size: 2.5rem; font-weight: 700; color: var(--text-color); margin-bottom: 1rem;">Simple Booking / Request System</h1>
                <p style="font-size: 1.2rem; color: var(--text-light); max-width: 800px; margin: 0 auto;">A simple request system to organize customer inquiries and service bookings.</p>
            </div>
